...
| watches.pattern                    | the pattern is a jquery like syntax. The outerhtml of the match is used as a body in all further processing. This is used to extract the relevant body in big html sites. If left empty the whole body is used                                                     |
