...
| watches.soft_error_patterns| regex patterns to match against the body to also count as an error. For example if you get an http 200 with an error text in the response. |
